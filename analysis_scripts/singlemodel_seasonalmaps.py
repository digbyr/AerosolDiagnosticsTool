...
#
#  For a given simulation: maps of AOD, AAOD, AE, and/or DOD.
#  Sim, obs, sim-obs for each season, using TWO reference datasets.
#
#  MISR and POLDER-GRASP get used for all except DOD because they're
#  the two obs datasets that have data for all 3 vars, allowing 
#  more consistent var-to-var comparison. But the downside is that 
#  POLDER-GRASP is only available for 2006-2012 so we're comparing 
#  against that climatology, not against the same years as the 
#  model simulated. This can easily be modified if desired.
#
#########################################################################
